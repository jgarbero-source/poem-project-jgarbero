...
This applications allows the client to create a user, login with that user's information, and browse a selection of poems. The user may also favorite a poem, create their own poem, edit their poem, and delete their poem. Additionally, the user can write comments on other poems as well as edit and delete the comments. The user also has the ability to look at all of their content in a clean and intuitive way. You can find the deployed website [here](https://poem-project-jgarbero.herokuapp.com/).
...
- The user can create their own poems and comments, as well as edit and delete them.
- The user can only create, edit, and delete their own poems or comments (ie, they cannot edit another's).
...
- Utilized aliasing to establish complex relationships between models
- Utilized controllers to bring data from the PostgreSQL database to the frontend
- Utilized serializers to show and organize data on the frontend easily
